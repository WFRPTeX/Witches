...
\statblock{Angela Trieste, Hedgewise}
...
\statblock{Hermann Rauch, Hedge Apprentice}
...
\statblock{Karina Str{\"o}m, Witch Hunter}
...
\statblock{``Schwarz'' Kristian, Gang Boss}
...
\statblock{Graf Sebastian Altmark, Magnate}
...
\statblock{Sara G{\"a}rtner, Burgomeister}

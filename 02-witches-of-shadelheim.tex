...
\subsection{Scene One: On Board the \textit{Bessie Blue}}\label{act1scene1}
...
Autumn in the Reikland is quite chilly and damp, so you expect to be spending
most of your time below deck.
...
leg. If characters can pass a \textbf{Challenging \mbox{(-10)} Charm Test} they can
get him to at least stop scowling when they're around, and even share a few
words about the weather. A further \textbf{Challenging (-10) Charm Test} will
...
interested in learning about. When they're done, move straight on to Scene Two.

\subsection{Scene Two: The \textit{Trout and Pike} Inn}\label{act1scene2}
...
secure their own lodgings in the inn, as the two crewmen sleep on board.
...
called the `Trout and Pike'. Calling it an ``inn'' gives it a little too much
credit, however; it's a small two-storey building with a thatched roof, visibly
subsiding slightly on one side. That said, all the windows are shining, and as
the Bessie Blue pulls up to the little jetty, captain Kaufmann calls out a
greeting to a woman standing in the doorway that could almost be called
friendly.
\end{callout}
...
young man to run physical jobs around the place.
